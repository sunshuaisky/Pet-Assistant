Create a single horizontal sprite strip for the Codex app digital pet `tuxie-actions` in the state `sleeping`.
...
Identity lock:
- Do not redesign the pet. Only change pose/action for the `sleeping` animation.
...
Animation action: sleeping curl and soft breathing.


State-specific requirements:
- Show Tuxie sleeping through a curled or loaf-like pose, closed eyes, tiny relaxed limbs, and subtle breathing changes across frames.
- Keep Tuxie cozy and recognizable with the same markings, black cap, white muzzle/chest, and compact body proportions.
- No bed, blanket, pillow, moon, Z letters, thought bubble, sleep icons, floating symbols, detached effects, smoke, stars, tears, dust, or shadows.
- The whole sleep pose must stay self-contained and unclipped in every frame.
